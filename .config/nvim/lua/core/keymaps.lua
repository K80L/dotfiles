...
-- vim.keymap.set('n', '<silent> <A-Left>', ':vertical resize -1<CR>')
...
vim.keymap.set('n', '<silent> <A-Up>', ':resize +2<CR>')
vim.keymap.set('n', '<silent> <A-Down>', ':resize -2<CR>')
vim.keymap.set('n', '<silent> <A-Left>', ':vertical resize -2<CR>')
vim.keymap.set('n', '<silent> <A-Right>', ':vertical resize +2<CR>')
